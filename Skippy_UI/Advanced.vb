Public Class Advanced
    ...
    Private Sub delayms_GotFocus(sender As Object, e As EventArgs) Handles delayms.GotFocus
        delayms.ResetText()
    End Sub
    Private Sub delayms_TextChanged(sender As Object, e As EventArgs) Handles delayms.TextChanged
        If IsNumeric(delayms.Text) Then
            Skippy.camwait = delayms.Text
        ElseIf delayms.Text = "" Then
            Exit Sub
        Else
            MessageBox.Show("Step Value is not numeric")
        End If
