...
extern "C" Skippy_interface_API bool preview();
extern "C" Skippy_interface_API long long int* initpreview();
...
Skippy_interface_API bool preview()
{
...
Skippy_interface_API long long int* initpreview()
{
    //return camera->preview();
    return camera->initpreview();
}
